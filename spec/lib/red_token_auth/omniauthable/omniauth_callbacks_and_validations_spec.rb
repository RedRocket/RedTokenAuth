...
RSpec.describe RedTokenAuth::Omniauthable::CallbacksAndValidations do
  it "should update UID if the user's provider is email" do
    @user = build(:user, email: "valid@email.com", password: "abcd1234", password_confirmation: "abcd1234")
    @user.provider = "email"
    @user.save
  ...
  it "should not create if email is already taken" do
    @user         = create(:user, email: "valid@email.com", password: "abcd1234", password_confirmation: "abcd1234")
    @another_user = build(:user, email: "valid@email.com", password: "abcd1234", password_confirmation: "abcd1234")
  ...
  it "should not update if email is already taken" do
    @user         = create(:user, email: "valid@email.com", password: "abcd1234", password_confirmation: "abcd1234")
    @another_user = create(:user, email: "valid.2@email.com", password: "abcd1234", password_confirmation: "abcd1234")
